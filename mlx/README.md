...
Both the forward and backward pass are numerically equivalent to the PyTorch code from `mamba.py`, as well as to the official [Mamba implementation](https://github.com/state-spaces/mamba).
...
- `📁 scripts` : example script to play around with Mamba.
